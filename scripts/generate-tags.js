...
const iconVersion = '20260702-cold-clean';
...
function renderHeader() {
  return `<header class="site-header">
    ...
    <div class="header-inner">
      <a class="brand" href="/"><span class="brand-mark"><img src="/favicon.svg?v=${iconVersion}" alt="" aria-hidden="true"></span><span><strong>The Strange Archive</strong><em>Legends, folklore, mysteries, and strange tales.</em></span></a>
